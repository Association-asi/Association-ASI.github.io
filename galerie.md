...
<div style="margin-bottom:40px;">
  <h3 style="color:#2e7fb5; border-bottom:3px solid #E8891A;
  ...
  <div class="galerie-grid">
    ...
    <div class="galerie-item galerie-pays">
      <div class="galerie-img-wrapper">
        ...
        <div class="galerie-overlay">
          <span><i class="fa-solid fa-kit-medical"></i> Matériel médical</span>
        </div>
      </div>
    ...
    <div class="galerie-item galerie-pays">
      <div class="galerie-img-wrapper">
        ...
        <div class="galerie-overlay">
          <span><i class="fa-solid fa-hospital"></i> Soutien hospitalier</span>
        </div>
      </div>
      <div class="galerie-legende">
    ...
    <div class="galerie-item galerie-pays">
      <div class="galerie-img-wrapper">
        ...
        <div class="galerie-overlay">
          <span><i class="fa-solid fa-venus"></i> Autonomie des femmes</span>
        </div>
      </div>
      <div class="galerie-legende">
    ...
    <div class="galerie-item galerie-pays">
      <div class="galerie-img-wrapper">
        ...
        <div class="galerie-overlay">
          <span><i class="fa-solid fa-shirt"></i> Don de vêtements</span>
        </div>
      </div>
      <div class="galerie-legende">
  ...
  <div class="galerie-grid">
    ...
    <div class="galerie-item">
      <div class="galerie-img-wrapper">
        ...
        <div class="galerie-overlay">
          <span><i class="fa-solid fa-hospital"></i> Voir en détail</span>
        </div>
      </div>
      <div class="galerie-legende">
    ...
    <div class="galerie-item">
      <div class="galerie-img-wrapper">
        <img src="https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=640"
             alt="Bénévoles">
        <div class="galerie-overlay">
          <span><i class="fa-solid fa-users"></i> Voir en détail</span>
        </div>
      </div>
      <div class="galerie-legende">
    ...
    <div class="galerie-item">
      <div class="galerie-img-wrapper">
        <img src="https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=640"
             alt="Enfants">
        <div class="galerie-overlay">
          <span><i class="fa-solid fa-heart"></i> Voir en détail</span>
        </div>
      </div>
      <div class="galerie-legende">
